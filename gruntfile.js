    ...
    shell: {
      ...
      run: {
        command: [
          ...
          'docker run --privileged -d -p 9000:9000 -v $(pwd)/dist:/app -v /portainerdata:/data -v /var/run/docker.sock:/var/run/docker.sock:z --name portainer portainer/base /app/portainer-linux-' + arch + ' --no-analytics'
        ].join(';')
      },
